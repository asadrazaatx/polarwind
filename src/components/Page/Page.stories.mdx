...
<Meta
  ...
  decorators={[
    withSmartKnobs({
      ignoreProps: ["children", "titleAction", "tabs", "title", "icon"],
    }),
  ]}
...
<Preview withToolbar>
  <Story decorators={[withKnobs]} name="Example">
    <Page
...
### Page with breadcrumb and custom title

Use when you need a more complex title. The example is presented here with the back button
and icon to illustrate responsive behavior and alignment.

<Preview>
  <Story name="Page with breadcrumb and custom title">
    <Page
      breadcrumbs={[{ content: "Apps", url: "/apps" }]}
      title={
        <Stack alignment="center" spacing="loose" wrap={false}>
          ...
          <Stack spacing="none" vertical>
            <Stack alignment="baseline">
              ...
              <Heading secondary>by Envoy</Heading>
            </Stack>
            <DisplayText secondary size="small">
              Turn health information into entry passes to reopen your office
              with confidence
            </DisplayText>
          </Stack>
        </Stack>
