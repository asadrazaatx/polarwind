...
<Meta
  component={Page}
  decorators={[withSmartKnobs({ ignoreProps: ["children", "titleAction", "title", "tabs"] })]}
...
Pass in a custom title component.

<Preview>
  <Story name="Page with custom title">
      <Page
        breadcrumbs={
          [
            {
        ...
        title={
          <Stack>
            ...
            >
              ...
              <Heading secondary>Easy desk booking for the hybrid workplace</Heading>
            </Stack>
          </Stack>
        }
      />
